...
// NOTE: These are illustrative historical values based on risk_dataset.csv patterns.
// In production, fetch these from the backend /debug/areas/ endpoint.
const frequencyData = [
  { region: "Manacaud",      floods: 21 },
  { region: "East Fort",     floods: 19 },
  { region: "Petta",         floods: 18 },
  { region: "Chackai",       floods: 17 },
  { region: "Vanchiyoor",    floods: 15 },
  { region: "Thycaud",       floods: 13 },
  { region: "Vattiyoorkavu", floods: 12 },
  { region: "Pattom",        floods: 11 },
  { region: "Ulloor",        floods: 10 },
  { region: "Nalanchira",    floods: 9 },
  { region: "Sreekaryam",    floods: 8 },
  { region: "Peroorkkada",   floods: 7 },
  { region: "Vellayambalam", floods: 6 },
  { region: "Kazhakkoottam", floods: 5 },
];
